...
import globalFunctions.getIntFromStringForLoop
...
//		val midNumber1 : Int = getIntFromStringForLoop(midNumber)
//		val midNumber2 : Int = getIntFromStringForLoop(midNumber)
...
//
//	val number1 : Int = getIntFromStringForLoop(birthDate, 0)
//	val number2 : Int = getIntFromStringForLoop(birthDate, 1)
//	val number3 : Int = getIntFromStringForLoop(birthDate, 3)
//	val number4 : Int = getIntFromStringForLoop(birthDate, 4)
//	val number5 : Int = getIntFromStringForLoop(birthDate, 6)
//	val number6 : Int = getIntFromStringForLoop(birthDate, 7)
//	val number7 : Int = getIntFromStringForLoop(birthDate, 8)
//	val number8 : Int = getIntFromStringForLoop(birthDate, 9)
//
//
...
//	{
//		val number1 : Int = getIntFromStringForLoop(personalityCard, 0)
//		val number2 : Int = getIntFromStringForLoop(personalityCard, 1)
//
...
//	val number5 : Int = getIntFromStringForLoop(currentYear, 0)
//	val number6 : Int = getIntFromStringForLoop(currentYear, 1)
//	val number7 : Int = getIntFromStringForLoop(currentYear, 2)
//	val number8 : Int = getIntFromStringForLoop(currentYear, 3)
//
//	val calculation : Int = calAddEightNum(number1, number2, number3, number4, number5, number6, number7, number8)
//
//	return finalCard(calculation, cardDeck)
